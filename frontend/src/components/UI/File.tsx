...
const File:React.FC<PropsFile> = ({accept, value, setValue}) => {
    return (
        <div className={classes.main}>
            <span className={classes.main__label}>Файл для импорта</span>
            <input type="file" accept={accept ?? 'text/xml'} className={classes.main__input} value={value} onChange={(e) => setValue(e)}/>
